...
export default class Proposals extends Component{
    ...
    render() {
        return <div>
            <Helmet>
                <title>Governance Proposals | Dropil Chain Testnet Explorer</title>
                <meta name="description" content="Dropil Chain incorporates on-chain governance. Come to see how on-chain governance can be achieved on the Dropil Chain Testnet Explorer." />
            </Helmet>
            <Row>
