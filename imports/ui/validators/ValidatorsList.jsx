...
export default class Validators extends Component{
    ...
    render() {
        ...
        return <div id="validator-list">
            <Helmet>
                <title>Dropil Chain Testnet Validator List | Dropil Chain Testnet Explorer</title>
                <meta name="description" content="Here is a list of Dropil Chain Testnet validators" />
            </Helmet>
            <Row>
