...
export default class AccountDetails extends Component{
    ...
    render(){
        ...
        if (this.state.loading){
            ...
            return <div id="account">
                <Helmet>
                    <title>Account Details of {this.state.address} | Dropil Chain Testnet Explorer</title>
                    <meta name="description" content={"Account Details of "+this.state.address+" on Dropil Chain Testnet"} />
                </Helmet>
                <Row>
